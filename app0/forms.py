...
class AddForm(forms.Form):
    ...
    migrationvm_name = forms.CharField(max_length=100, label='部署位置')
    serverzone_dst = forms.CharField(max_length=100, label='部署位置')
    filepath = forms.CharField(max_length=100, label='部署位置')
    imagename = forms.CharField(max_length=100, label='类型')
    service_type = forms.CharField(max_length=100, label='类型')
    appversion = forms.CharField(max_length=100, label='类型')
    osname = forms.CharField(max_length=100, label='类型')
